...
```sh
  cd Folder_Name
  git clone https://github.com/manzitresor/space_traveler_hub.git
```
...
Feel free to check the <a href="https://github.com/manzitresor/space_traveler_hub/issues">issues page</a>
